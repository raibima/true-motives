...
function parseStatus(status: string | string[] | undefined): InvestigationStatus | 'all' {
  if (
  ...
  return (
    <div className="px-8 py-8">
      ...
      <div className="mb-8 flex items-start justify-between">
        <div>
          <h1 className="mb-1 font-serif text-2xl font-semibold text-(--tm-color-primary-900)">
            Investigations
          </h1>
          ...
          <StatusBanner
            ...
            action={
              <Link
                ...
                variant="plain"
                className="text-xs font-semibold text-(--tm-color-accent-700) transition-colors hover:text-(--tm-color-accent-500)"
              >
                View progress →
              </Link>
            }
