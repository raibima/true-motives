...
const styles = tv({
  ...
  variants: {
    variant: {
      primary:
        'underline text-blue-600 dark:text-blue-500 decoration-blue-600/60 hover:decoration-blue-600 dark:decoration-blue-500/60 dark:hover:decoration-blue-500',
      secondary:
        'underline text-neutral-700 dark:text-neutral-300 decoration-neutral-700/50 hover:decoration-neutral-700 dark:decoration-neutral-300/70 dark:hover:decoration-neutral-300',
      plain: 'no-underline',
      button:
