...
> = {
  accent: {
    container:
      "border-(--tm-color-accent-500)/30 bg-(--tm-color-accent-400)/10",
  ...
  success: {
    container:
      "border-(--tm-color-success-500)/30 bg-(--tm-color-success-100)/60",
    text: "text-(--tm-color-success-600)",
    dot: "bg-(--tm-color-success-500)",
  },
  danger: {
    container:
      "border-(--tm-color-danger-500)/30 bg-(--tm-color-danger-100)/60",
